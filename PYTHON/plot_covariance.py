...
#==============================================================================
    ...
    cf = ax.contourf(x, y, ANOM[:, :, 2], cmap = div, levels = levels)
...
#==============================================================================
    ...
    map.colorbar(cf, location='right')
    plt.savefig('../FIG/' + VAR + '-U_Covariance.png')
...
#==============================================================================
    ...
    map.colorbar(cf, location='right')
    plt.savefig('../FIG/' + VAR + '-V_Covariance.png')
...
#==============================================================================
    ...
    map.colorbar(cf, location='right')
    plt.savefig('../FIG/' + VAR + '-PHI_Covariance.png')
